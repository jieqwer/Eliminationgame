...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>Who To Play</div><p>The goal of Hextris is to stop blocks from leaving the inside of the outer gray hexagon.</p><p>" + (settings.platform != 'mobile' ? 'Press the right and left arrow keys' : 'Tap the left and right sides of the screen') + " to rotate the Hexagon</p><p>Clear blocks and get points by making 3 or more blocks of the same color touch.</p><p>Time left before your combo streak disappears is <span style='color:#f1c40f;'>The</span> <span style='color:#e74c3c'>colour</span> <span style='color:#3498db'>indicated</span> <span style='color:#2ecc71'>by</span>  outer hexagon</p> <hr> <p id = 'afterhr'></p>by ");
	if (gameState == 1) {
		pause();
	}
